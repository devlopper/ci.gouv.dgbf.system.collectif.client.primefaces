...
public interface Helper {
	...
	Collection<String> VISIBLE_AMOUNTS_COLUMNS_FIELDS_NAME = List.of(ExpenditureAmounts.FIELD_INITIAL//,ExpenditureAmounts.FIELD_MOVEMENT
			/*,Amounts.FIELD_ACTUAL*/,Amounts.FIELD_MOVEMENT_INCLUDED,ExpenditureAmounts.FIELD_INITIAL_PLUS_MOVEMENT_INCLUDED
			,Amounts.FIELD_EXPECTED_ADJUSTMENT,Amounts.FIELD_ADJUSTMENT,Amounts.FIELD_MOVEMENT_INCLUDED_PLUS_ADJUSTMENT,Amounts.FIELD_EXPECTED_ADJUSTMENT_MINUS_ADJUSTMENT
			/*,Amounts.FIELD_ACTUAL_PLUS_ADJUSTMENT,Amounts.FIELD_ACTUAL_MINUS_MOVEMENT_INCLUDED_PLUS_ADJUSTMENT*/,Amounts.FIELD_INITIAL_PLUS_MOVEMENT_INCLUDED_PLUS_ADJUSTMENT);
}